...
class CustomNavBar extends StatefulWidget {
  ...
  static late AnimationController animCustomNavBar;
...
class _CustomNavBarState extends State<CustomNavBar>
  ...
  @override
  void initState() {
    CustomNavBar.animCustomNavBar = AnimationController(
      vsync: this,
  ...
  Widget build(BuildContext context) {
    return SlideTransition(
      position: Tween(
        begin: Offset(0, 10.4.hmea),
        end: Offset(0, 13.hmea),
      )
          .chain(
            CurveTween(curve: Curves.easeInExpo),
          )
          .animate(
            CustomNavBar.animCustomNavBar,
          ),
      child: Container(
        width: 100.w - 40,
