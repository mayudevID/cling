...
class AddExpensePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeBloc, HomeState>(
      buildWhen: (prev, curr) {
        return prev.isLoadDataDropdown != curr.isLoadDataDropdown;
      },
      builder: (context, state) {
        if (state.isLoadDataDropdown) {
          return SizedBox(
            width: 100.w,
            height: 100.h,
            child: Center(
            ...
            children: [
              ...
              DropdownButtonHideUnderline(
                child: DropdownButton2(
                  ...
                  items: [
                    ...state.listExCategories!.map(
                      (item) => DropdownMenuItem<ExpenseCategoriesModel>(
                        value: item,
                        child: Row(
                          children: [
                            Text(
                              item.expenseCategories.substring(
                                0,
                                item.expenseCategories.indexOf(" "),
                              ),
                            ...
                            Expanded(
                              child: Text(
                                item.expenseCategories.substring(
                                  item.expenseCategories.indexOf(" ") + 1,
                                ),
                                style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 12.5.sp,
                  ...
                  onChanged: (value) {
                    //ExpenseCategoriesModel.onChanged(context, value!);
                  },
